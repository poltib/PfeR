...
(function() {
  var NUMBER_DOT_TWONUMBERS, SAMPLES, alert, calc_bounds, chart, display_on_map, drawPath, elevationReqActive, elevationService, elevations, gm_init, gm_service, growPath, load_track, newRoute, notice, path, plotElevation, poly, poly_init;
  ...
  $(".tracks.new, .happeningtracks.new").ready(function() {
  ...
  $(".tracks.show, .happenings.show").ready(function() {
    var map;
    map = gm_init();
